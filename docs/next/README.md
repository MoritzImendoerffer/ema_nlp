...
| [`tree_retrieval_followups.md`](tree_retrieval_followups.md) | 📋 planned | Fix **seeding** for tree-aware retrieval. The traversal landed 2026-07-20 and works; the first T5 showcase run showed broad questions seed on meeting minutes instead of the hub page. Measure the miss, then hub-aware seeding; `tree_context` tool deferred behind that. |
