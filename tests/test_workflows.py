...
from harness.workflows.utils import Doc, WorkflowRunner, format_docs, extract_answer
...
class TestUtils:
    ...
    def test_format_docs_with_doc(self):
        doc = Doc(page_content="Q: What?\n\nA: Answer.", metadata={"qa_id": "qa1", "score": 0.9, "source_url": "https://x.com"})
...
class TestSimpleRAGWorkflow:
    ...
    def test_docs_are_doc_instances(self, index):
        from harness.workflows.simple_rag import SimpleRAGWorkflow
        from harness.workflows.utils import Doc
